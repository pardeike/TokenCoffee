...
final class DemoQuotaDataTests: XCTestCase {
    func testBundledDemoQuotaDataLoadsRealWorldTrace() throws {
        ...
        XCTAssertEqual(forecast.lowProjectedWeeklyUsedPercentAtReset, 89.893, accuracy: 0.001)
        XCTAssertEqual(forecast.highProjectedWeeklyUsedPercentAtReset, 157.887, accuracy: 0.001)
        XCTAssertGreaterThan(forecast.highProjectedWeeklyUsedPercentAtReset - forecast.lowProjectedWeeklyUsedPercentAtReset, 60)
        ...
        XCTAssertEqual(firstHighSegment.endUsedPercent, firstHighSegment.startUsedPercent, accuracy: 0.001)
